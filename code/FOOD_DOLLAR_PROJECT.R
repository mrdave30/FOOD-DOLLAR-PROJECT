...
base_dir <- "C:\\Users\\Nkoro\\Food and Agriculture Organization\\ESSDC - Data Generation and Capacity Building WorkSpace - EORA data\\Eora26\\test" # this is the directory from the Code Author.Data are storaged at: "https://unfao.sharepoint.com/:f:/s/ESSDC/Egm7c-wP3wtOsmsBEQW7x-IBd6E8RX0o7S-6vRlRlPl3mw?e=VvEdmX", so this link should be set as directory and here should be added years different from 2007.  
setwd(base_dir) 
